...
<body bgcolor="#FFFFCC">
  ...
  <!-- ZipCheck.jsp?area3='미아2동'&check=n -->
   <form name="zipForm" method="post"  action="ZipCheck.jsp">
        ...
        히든객체를 쓴 이용 사용자가 검색어를 입력하고 검색버튼을 눌렀는지 안눌렀지를 체크할 변수로 사용 
         -->
        <input type="hidden" name="check"  value="n">
   </form>
   <!-- 
   	새로운 창이 open(X) 폼태그아래에서 검색결과를 출력 
    -->
    <%
   ...
   *검색후 ,아래 우편번호를 클릭하면 자동으로
     ...
     ZipcodeDTO zipBean=zipcodeList.get(i); //zipcodeList.elementAt(i) 백터라면
