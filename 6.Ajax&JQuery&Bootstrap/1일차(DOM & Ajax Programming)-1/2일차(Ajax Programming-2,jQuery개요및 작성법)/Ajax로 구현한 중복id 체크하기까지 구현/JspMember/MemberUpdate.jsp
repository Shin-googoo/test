...
<br><br>
<%
   //MemberUpdate.jsp?mem_id='nup'
   //String mem_id=request.getParameter("mem_id"); //값을 입력 or 링크걸어서 연결
   String mem_id=(String)session.getAttribute("idKey");//session.setAttribute() 저장?
    ...
    <td align="center" valign="middle" bgcolor="#FFFFCC"> 
      <table border="1" cellspacing="0" cellpadding="2"  align="center">
        <form name="regForm" method="post" action="MemberUpdateProc.jsp">
		  ...
		  <tr>  
            <td>직업</td><!-- 콤보박스에 없는 값을 필드에 저장시키면 연결이 되지 않은이유  -->
